...
<template>
  <div class="prose mx-auto max-w-4xl">
    <AppSection class="not-prose">
      <ComponentsPreview>
        <div class="flex flex-col gap-16">
          <AppBlock>
            <template #header>
              <h1 class="font-600">Block Header</h1>
            </template>
            <div class="px-24 pb-24">
              <p>This is block content</p>
            </div>
            <template #footer> Block Footer </template>
          </AppBlock>

          <AppBlock bordered>
            <template #header>
              <h1 class="font-600">Bordered Block</h1>
            </template>
            <div class="px-24 pb-24">
              <p>This is block content</p>
            </div>
          ...
          <AppBlock :rounded="16">
            <template #header>
              <h1 class="font-600">Rounded 16 Block</h1>
            </template>
            <div class="px-24 pb-24">
              <p>This is block content</p>
            </div>
    ...
    <AppSection>
      <AppBlock bordered>
        <div class="p-24">
          <MarkdownRenderer class="max-w-4xl" file-path="docs/block.md" />
        </div>
      </AppBlock>
    </AppSection>
  </div>
