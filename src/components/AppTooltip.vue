...
const classes = computed(() => {
  return [
    twMerge('bg-black-100 text-white', props.class),
    {
      ...
      '-ml-8 top-[50%] translate-y-[-50%] left-[0] -translate-x-full': props.position === 'left',
      '-mr-8 top-[50%] translate-y-[-50%] right-[0] translate-x-full': props.position === 'right',
      '-mt-8 top-[0] left-[50%] translate-x-[-50%] -translate-y-full': props.position === 'top',
      'mt-8 left-[50%] translate-x-[-50%]': props.position === 'bottom'
    }
  ]
})
</script>
